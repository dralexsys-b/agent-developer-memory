...
Документы, обеспечивающие сопровождение репозитория, навигацию по документации и управление инженерным процессом. Они не относятся непосредственно к архитектурным слоям системы и служат для навигации, управления и сопровождения проекта.

### Repository Navigation

- **DOCUMENTS.md** — реестр всех документов проекта
- **REPOSITORIES.md** — реестр всех репозиториев проекта
- **CURRENT_CONTEXT.md** — текущий операционный контекст проекта
- **CODE_INDEX.md** — индекс всего исходного кода

### Program Management

- **PROGRAM_MANAGEMENT.md** — управление программами проекта
- **PROGRAMS.md** — реестр всех программ проекта
- **RELEASES.md** — история всех релизов
